...
const TourAddForm = () => {
    ...
    const handleSubmit = () => {
        const url = param.id ? `https://tour-backend-i1a8.onrender.com/api/v1/tours/${param.id}` : "https://tour-backend-i1a8.onrender.com/api/v1/tours";
    ...
    return (
        <Col md={6}>
            <Form className="form__table">
                ...
                <FormGroup>
                    <Label for="address">Main City You Wnat To Explore:</Label>
                    <Input type="text" id="address" value={tour.address} onChange={(e) => handleInputChange("address", e.target.value)} placeholder="Main City You Wnat To Explore" />
                </FormGroup>
                <FormGroup>
